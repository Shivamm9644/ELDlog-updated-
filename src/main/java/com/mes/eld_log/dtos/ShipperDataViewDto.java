...
public class ShipperDataViewDto {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ShipperDataViewDto)) {
         return false;
      } else {
         ShipperDataViewDto other = (ShipperDataViewDto)o;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof ShipperDataViewDto;
   }
   ...
   public String toString() {
      return "ShipperDataViewDto(dispatchId="
         + this.getDispatchId()
         + ", shipperId="
         + this.getShipperId()
         + ", shipperName="
