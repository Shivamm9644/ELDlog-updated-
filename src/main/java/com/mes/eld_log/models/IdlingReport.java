...
public class IdlingReport implements Serializable {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof IdlingReport)) {
         return false;
      } else {
         IdlingReport other = (IdlingReport)o;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof IdlingReport;
   }
